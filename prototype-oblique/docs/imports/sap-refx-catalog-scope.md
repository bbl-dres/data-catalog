...
Reviewed inventories are stored in [sap-refx-data-sources.json](../sources/sap-refx/sap-refx-data-sources.json) and selected in [sap-refx-catalog-curation.json](../sources/sap-refx/sap-refx-catalog-curation.json):
