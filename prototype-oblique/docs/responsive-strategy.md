...
- Catalog/handbook navigation keeps the existing **240 px expanded sidebar** and **56 px icon rail**, including the user's saved preference. Resizing does not silently overwrite that preference.
