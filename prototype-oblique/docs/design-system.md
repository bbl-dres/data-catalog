...
| Choice popover | `.ob-choice-popover`, body and actions classes share the fixed surface, scrolling body and wrapping actions. | Catalog/print contents, anchor positioning, width and event lifecycle. |
