...
| [Canonical catalog data model](data-model.md) | Review before launch: complete dictionaries, schema inventory and ER diagram, keys, cardinalities, constraints, known gaps and standards alignment. |
