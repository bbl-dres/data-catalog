...
| [App explainer — Version 1](video/2026-09-15-landscape/README.md) | Selected for the app: NotebookLM adaptation, landscape diagrams, editable Shotcut timeline and subtitles. |
| [Alternative explainer — Version 2](video/2026-09-15-version-2/README.md) | Saved alternative with a practical Baujahr example, real catalog captures, Corinna narration, editable Shotcut timeline and subtitles. |
