...
The introduction uses the user's preferred [Version 1](video/2026-09-15-landscape/README.md): `assets/bbl-datenkatalog-landscape.mp4` (76 seconds, 1920 × 1080), with landscape diagrams and the supplied NotebookLM audio. It plays in a responsive 16:9 HTML video element with the browser's native controls, inline playback, metadata preload and a local poster. German WebVTT subtitles are optional through the native player. Playback starts only on request. The local media source is permitted by CSP; no external player is loaded. [Version 2](video/2026-09-15-version-2/README.md), both versions' editable Shotcut projects and all earlier media remain saved in the repository.
