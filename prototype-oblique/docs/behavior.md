...
Profile overview section headings toggle their content with a chevron, using click, Enter or Space. **System** starts collapsed; **Kerndaten**, **Informationsschutz** and **Verantwortlich** start expanded. Each section is independent. Choices survive re-renders and tab changes within the current entry; visiting another entry or reloading restores the defaults. Collapsed sections remain included in print and exports. Edit forms keep their fields expanded.
