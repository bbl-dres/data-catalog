...
- Handbook with chapter navigation, a [real Supabase OpenAPI 3.1 reference](docs/api.md) with public read requests in Swagger UI, and a help and contact popover.
