...
(async()=>{
 ...
 try{
  ...
  console.log('PASS: reproduced hosted write-grant drift; repair is repeatable, preserves all rows and SELECT, and all current incremental migrations apply with 477 columns and no direct API-role writes.');
