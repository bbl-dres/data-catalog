...
const labelsSql = fs.readFileSync(path.join(root, 'supabase/archive/20260907-business-object-labels.sql'), 'utf8');
const sql = fs.readFileSync(path.join(root, 'supabase/archive/20260907-business-object-geometry.sql'), 'utf8');
