...
| `row-order.cjs` / `row-order-browser.cjs` | Consistent ranks across five child types, browser/REST append, archive positions, retries, invalid ranks, Excel values and languages, visible-row movement and saved-order reset; PGlite and Playwright |
