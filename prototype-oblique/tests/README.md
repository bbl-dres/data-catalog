...
node prototype-oblique/tests/api-fields.cjs
node prototype-oblique/tests/api-fields-browser.cjs
...
| `model-aliases.cjs` | Canonical Markdown against all 481 actual SQL/API column aliases, nested JSON labels, generated EN/DE copy, form/column definitions, print snapshots, XLSX headers and distinct definition/service versions; requires PGlite |
