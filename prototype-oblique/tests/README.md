...
| `model-aliases.cjs` | Canonical Markdown against all 477 actual SQL/API column aliases, nested JSON labels, generated EN/DE copy, form/column definitions, print snapshots, XLSX headers and distinct definition/service versions; requires PGlite |
