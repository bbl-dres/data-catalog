...
INSERT INTO concept_attribute (id, concept_id, name_en, name_de, name_fr, name_it, definition, value_type, code_list_id, required, standard_ref, sort_order, key_role) VALUES
  ...
  ('uuid-cattr-012', 'uuid-concept-003', 'Municipality BFS No.','Gemeinde-BFS-Nr',     'No commune OFS',       'Nr comune UST',
   ...
   'integer', NULL, 1, 'eCH-0071', 3, NULL),
  ...
  ('uuid-cattr-017', 'uuid-concept-004', 'Building Category',  'Gebäudekategorie',    'Categorie de batiment','Categoria di edificio',
   ...
   'code', 'uuid-codelist-001', 1, 'eCH-0071', 3, 'FK'),
  ...
  ('uuid-cattr-019', 'uuid-concept-004', 'Energy Source',      'Energieträger',       'Agent energetique',    'Vettore energetico',
   ...
   'code', 'uuid-codelist-003', 0, 'GWR', 5, 'FK'),
  ...
  ('uuid-cattr-021', 'uuid-concept-005', 'Usage Type',         'Nutzungsart',          'Type d''utilisation',  'Tipo di utilizzo',
   ...
   'code', 'uuid-codelist-002', 1, 'SIA 416', 2, 'FK'),
  ...
  ('uuid-cattr-045', 'uuid-concept-011', 'Condition Type',     'Konditionsart',        'Type de condition',    'Tipo di condizione',
   ...
   'code', 'uuid-codelist-005', 1, NULL, 1, 'FK'),
  ...
  ('uuid-cattr-050', 'uuid-concept-012', 'Type',               'Typ',                  'Type',                 'Tipo',
   ...
   'code', 'uuid-codelist-003', 1, NULL, 2, 'FK'),
  ...
  ('uuid-cattr-080', 'uuid-concept-019', 'Chart of Accounts',  'Kontenplan',           'Plan comptable',       'Piano dei conti',
   ...
   'text', NULL, 1, 'SAP FI', 4, NULL);

-- ─────────────────────────────────────────────────────────────────────────────
-- 7. CODE LISTS
-- ─────────────────────────────────────────────────────────────────────────────

INSERT INTO code_list (id, concept_id, name_en, name_de, name_fr, name_it, source_ref, version, status, owner_id) VALUES
...
INSERT INTO data_profile (id, dataset_id, row_count, null_percentage, cardinality, min_value, max_value, completeness_score, format_validity_score, timeliness_score, accuracy_score, consistency_score, uniqueness_score, sample_values, profiled_at, profiler) VALUES
  ('uuid-prof-001', 'uuid-ds-001', 8450,  0.03, 8450,  '1000001', '1008450', 0.97, 0.99, 0.95, 0.96, 0.94, 1.00, '["1000001", "1003421", "1007892"]', '2024-12-01T02:30:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-002', 'uuid-ds-002', 32100, 0.05, 32100, 'MO-00001','MO-32100',0.95, 0.98, 0.88, 0.93, 0.91, 1.00, '["MO-00001", "MO-15234", "MO-31999"]', '2024-12-01T02:45:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-003', 'uuid-ds-003', 15600, 0.04, 15600, 'MV-2020-001','MV-2024-999',0.96, 0.97, 0.82, 0.90, 0.89, 1.00, '["MV-2020-001", "MV-2023-456"]', '2024-12-01T03:00:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-004', 'uuid-ds-004', 42000, 0.06, 42000, 'KD-00001','KD-42000',0.94, 0.96, 0.79, 0.88, 0.87, 1.00, '["KD-00001", "KD-21000", "KD-41999"]', '2024-12-01T03:15:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-005', 'uuid-ds-005', 18500, 0.02, 18500, 'BP-00001','BP-18500',0.98, 0.99, 0.97, 0.97, 0.96, 1.00, '["BP-00001", "BP-09250", "BP-18499"]', '2024-12-01T03:30:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-006', 'uuid-ds-006', 9200,  0.02, 9200,  '10001',   '19200',   0.98, 0.99, 0.93, 0.95, 0.94, 1.00, '[10001, 14523, 18999]', '2024-12-02T01:30:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-007', 'uuid-ds-007', 3400,  0.01, 3400,  'P-3001',  'P-6400',  0.99, 0.99, 0.96, 0.98, 0.97, 1.00, '["P-3001", "P-4500", "P-6400"]', '2024-12-02T01:45:00Z', 'catalog-scanner v2.1'),
  ('uuid-prof-008', 'uuid-ds-008', 12600, 0.08, 12600, '6001',    '18600',   0.92, 0.95, 0.65, 0.82, 0.80, 0.98, '[6001, 10234, 18599]', '2024-11-20T08:30:00Z', 'catalog-scanner v2.1');
